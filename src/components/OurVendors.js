...
const brands = ["/tata.png", "/timken.png", "/tatabluescope.png", "/housemoving.png"];

const OurVendors = () => {
  return (
    <section className="w-full bg-gray-100 text-center py-16 px-50 overflow-hidden">
      {/* Title */}
      ...
      <div className="relative w-full overflow-hidden mt-8">
        <div className="flex space-x-12 animate-scroll">
          {brands.map((brand, index) => (
            <div key={index} className="w-24 h-24 flex-shrink-0 rounded-full overflow-hidden">
